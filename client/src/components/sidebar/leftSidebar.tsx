      ...
      <div className="flex flex-col h-full bg-white/80 backdrop-blur-sm">
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent">
          <div className="space-y-1 py-2">
            <TasksFilter taskKey="team" title="All Teams" data={teamData} />
            <TasksFilter taskKey="priority" title="All Priorities" data={priorityData} />
            <TasksFilter taskKey="tag" title="All Tags" data={tagData} />
          </div>
        </div>
        <div className="border-t border-gray-100 bg-white/90 p-2 space-y-1">
          <button 
            onClick={handleSettings}
            className="w-full flex items-center gap-2 px-3 py-2 text-gray-700 hover:bg-gray-50 rounded-lg transition-all duration-200 group"
          >
          ...
          <button 
            ...
            className="w-full flex items-center gap-2 px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 group"
          >
